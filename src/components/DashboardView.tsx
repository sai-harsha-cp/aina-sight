                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2">
                        <div className={`px-2 py-0.5 rounded text-xs ${
                          categoryCompliance >= 85 ? 'bg-green-100 text-green-800' :
                    ...
                    {categorySops.map((sop) => {
                      ...
                      return (
                        <div 
                          ...
                          onClick={() => onNavigateToEvidence(category, sop.name)}
                        >
                          <div className="flex items-center gap-3">
                            {sopIcons[sop.name]}
                            <div className="flex-1 min-w-0">
                              <div className="text-sm text-gray-900 truncate group-hover:text-blue-600 transition-colors">
                                {sop.name}
                              </div>
